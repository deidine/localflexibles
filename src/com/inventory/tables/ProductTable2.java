...
//      product.addColumn("Code Prod");
//            product.addColumn("Nom Prod");
//            product.addColumn("PrixAchat");
//            product.addColumn("PrixVente");
//            product.addColumn("Marque");
//            product.addColumn("Quentite");

    public String[] getColums() {
        String[] COLUMNS = {
            "Code_Produit", "Nom_Produit",   "Marque", "quentite"
        };
        return COLUMNS;
